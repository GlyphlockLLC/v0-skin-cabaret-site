...
// Using system fonts to avoid external dependencies in build
const fontVars = {
  "--font-montserrat": "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', sans-serif",
  "--font-jetbrains-mono": "'SF Mono', Monaco, Inconsolata, 'Roboto Mono', Consolas, 'Courier New', monospace"
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="font-sans antialiased" style={fontVars}>
