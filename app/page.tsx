        ...
        <footer className="relative py-16 border-t border-red-500/30 bg-black/90">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
              ...
              {/* Sister Club */}
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-red-400 mb-4">Sister Club</h3>
                <div className="text-white/80">
                  <p className="text-sm mb-2">Visit our sister location</p>
                  <a
                    href="https://www.sugars.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-red-400 hover:text-red-300 font-semibold transition-colors block"
                  >
                    Sugar's Cabaret
                  </a>
