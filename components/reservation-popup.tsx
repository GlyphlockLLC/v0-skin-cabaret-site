...
import { X, Calendar, Clock, Users, Star, Gift, Shield, Phone, CheckCircle } from "lucide-react"

interface ReservationPopupProps {
  isOpen: boolean
  onClose: () => void
  type: "bachelor" | "vip" | "table"
}
        ...
        return [
          {
            ...
            price: "$500",
            features: ["VIP Table", "Bottle Service", "Dedicated Host"],
          },
          {
            id: "premium",
            name: "Premium Package",
            price: "$1,000",
            features: ["Private Booth", "Premium Bottles", "Transportation", "VIP Host"],
          },
          {
            id: "platinum",
            name: "Platinum Package",
            price: "$2,000",
            features: ["Private Room", "Top Shelf Service", "Limo Service", "Personal Concierge", "Photo Package"],
          },
        ]
      case "vip":
        return [
          {
            ...
            name: "Gold VIP",
            price: "$300",
            features: ["VIP Seating", "Bottle Service", "Priority Service"],
          },
          {
            id: "platinum",
            name: "Platinum VIP",
            price: "$600",
            features: ["Private Booth", "Premium Service", "Complimentary Appetizers"],
          },
          {
            id: "diamond",
            name: "Diamond VIP",
            price: "$1,200",
            features: ["Private Room", "Elite Service", "Full Dinner Service", "Personal Host"],
          },
        ]
      default:
        return [
          { id: "standard", name: "Standard Table", price: "$150", features: ["Reserved Seating", "Table Service"] },
          {
            id: "premium",
            name: "Premium Table",
            price: "$300",
            features: ["VIP Seating", "Bottle Service", "Priority Access"],
          },
        ]
    }
  }
...
${formData.transportation ? "Transportation: YES" : ""}
${formData.vipUpgrade ? "VIP Upgrade: YES" : ""}
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        <div className="flex items-center justify-center space-x-2 mb-4">
          ...
          <span className="text-gold font-bold">STEP 1: BASIC INFORMATION</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <option value="21+">21+ People (Call for Custom Package)</option>
          </select>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        <div className="flex items-center justify-center space-x-2 mb-4">
          ...
          <span className="text-gold font-bold">STEP 2: SELECT PACKAGE</span>
        </div>
      </div>
      ...
      <div className="space-y-4 pt-4 border-t border-red-600/30">
        <h4 className="text-lg font-bold text-white mb-3">PREMIUM ADD-ONS</h4>
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        <div className="flex items-center justify-center space-x-2 mb-4">
          ...
          <span className="text-gold font-bold">STEP 3: FINAL DETAILS</span>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-gold/20 to-gold/10 border border-gold/30 rounded-lg p-4">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <span className="text-gold font-bold">PREMIUM GUARANTEE</span>
        </div>
        <p className="text-white/90 text-sm">
          Your reservation is protected by our premium service guarantee. We ensure the highest quality experience with
          professional staff, world-class entertainment, and exceptional service standards.
        </p>
      </div>
    </div>
  )
